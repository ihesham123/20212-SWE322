...
<?php 
      ...
      if(mysqli_num_rows($result) > 0){
        echo (
         ...
         while($rows = mysqli_fetch_row($result)){
          ...
          echo ("</table> <br/> <input type='submit' name='enroll' value='Confirm Erollment'/> </h3>");
      }
    }
  }else {
  ...
  }else if(isset($_POST['enroll']) && empty($_POST['class_id'])) { // if pressed confirm and no classes selected
    echo "<h3> Please select <a href='../www/courses.php'>Courses</a> to enroll into </h3> <br>";
  }
