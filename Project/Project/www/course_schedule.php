...
<?php
            ...
            echo (
             ...
             while($rows = mysqli_fetch_row($result)){
              if ($rows[3] < $rows[4]) {  // check if class not full
                echo (
                "<tr> <form action='../www/course_schedule.php' method='post'>
    ...
    echo "<h3>Please <a href=../www/Login.php>Login</a> to see your courses.</h3>";
    }
    ...
    echo("<meta http-equiv='refresh' content='0'>"); // reload the page to update content
        ...
        echo "<h3> Please select <a href='../www/course_schedule.php'>Courses</a> to drop from </h3> <br>";
    }
